							...
							<li className="product-nicescroll-bar row">
								<ul className="pa-20">
									<li className="col-md-3 col-xs-6 col-menu-list">
										...
										<a href="widgets.html"><div className="pull-left"><i className="zmdi zmdi-flag mr-20"></i><span className="right-nav-text">widgets</span></div><div className="pull-right"><span className="label label-warning">8</span></div><div className="clearfix"></div></a>
										<hr className="light-grey-hr ma-0"/>
										<a href="documentation.html"><div className="pull-left"><i className="zmdi zmdi-book mr-20"></i><span className="right-nav-text">documentation</span></div><div className="clearfix"></div></a>
										<hr className="light-grey-hr ma-0"/>
									</li>
									<li className="col-md-3 col-xs-6 col-menu-list">
